...
const RegisterPage = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-screen" style={{ backgroundImage: `url(${backgroundImageUrl})` }}>
      ...
      <div className="rounded-md bg-gradient-to-r from-rose-600 to-red-400 h-[19.5rem] w-[25rem] flex flex-col items-center shadow-lg shadow-slate-600" style={{ zIndex: 3 }}>
        <div className="flex flex-col justify-center items-center w-full">
          <h1 className="text-white font-bold text-3xl mt-[1rem] mb-[2rem]">Register Here</h1>
          ...
          <input onChange={handleInput} id="username" type="text" className="font-bold border-2 border-slate-600 focus:outline-none px-2 py-1 rounded-md h-[2.5rem] w-[20rem] mb-[1rem]" placeholder="Username"/>
        ...
        <div className="btn-section">
          <div className="flex flex-row justify-center w-[20rem] my-[1rem]">
            <button onClick={() => {registerUser();}} className="bg-white hover:bg-rose-100 rounded-md w-[10rem] mr-[1rem] h-[2.5rem] font-bold font-poppins tracking-wider focus:outline-none">
              Register
            </button>
          </div>
        </div>
